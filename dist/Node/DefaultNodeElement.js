...
var DefaultNodeElement = function (_a) {
    var nodeDatum = _a.nodeDatum, toggleNode = _a.toggleNode, onNodeClick = _a.onNodeClick, onNodeRightClick = _a.onNodeRightClick, onNodeMouseOver = _a.onNodeMouseOver, onNodeMouseOut = _a.onNodeMouseOut;
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement("circle", { r: DEFAULT_NODE_CIRCLE_RADIUS, onClick: function (evt) {
                toggleNode();
                onNodeClick(evt);
            }, onContextMenu: onNodeRightClick, onMouseOver: onNodeMouseOver, onMouseOut: onNodeMouseOut }),
