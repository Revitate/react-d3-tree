...
var Tree = /** @class */ (function (_super) {
    ...
    function Tree() {
         ...
         * Handles the user-defined `onNodeClick` function.
         */
        _this.handleOnNodeRightClickCb = function (hierarchyPointNode, evt) {
            var onNodeRightClick = _this.props.onNodeRightClick;
            if (onNodeRightClick && typeof onNodeRightClick === 'function') {
                onNodeRightClick(clone_1.default(hierarchyPointNode), evt);
            }
        };
        /**
